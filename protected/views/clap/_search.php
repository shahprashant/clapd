...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'clap'); ?>
		<?php echo $form->textArea($model,'clap',array('rows'=>6, 'cols'=>50)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'refreshtime'); ?>
		<?php echo $form->textField($model,'refreshtime'); ?>
	</div>
